...
import de.henrik.bt.AttributeValueChangeFunction;
...
class TestAttributeValueChangeFunction {
	...
	public void beforeTest(TestInfo testInfo) throws IOException {
		...
		if (testInfo.getDisplayName().equals("AttributeValueChangeFunctionTest()")) {
			when(request.getMethod()).thenReturn("POST");
		}
	...
	@Test
	public void AttributeValueChangeFunctionTest() throws Exception {
		...
		new AttributeValueChangeFunction().service(request, response);
	...
	@Test
	public void AttributeValueChangeFunctionWrongAPIKeyTest() throws Exception {
	...
	@Test
	public void AttributeValueChangeFunctionNoAPIKeyTest() throws Exception {
